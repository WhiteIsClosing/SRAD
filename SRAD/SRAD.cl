...
__kernel void CQ(__constant     struct  param*  par,
                 __global       const   float*  imgSrc,
                 __global               float*  cqM)
{
...
__kernel void SRAD(__constant   struct  param*  par,
                   __global     const   float*  cqM,
                   __global     const   float*  imgSrc,
                   __global     float*  imgDes)
{
    int     iWidth  = par->iWidth;
    int     iHeight = par->iHeight;
    int     it      = par->it;
